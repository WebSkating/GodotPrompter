...
- **Design:** When the request has open design decisions, read `skills/godot-grill/SKILL.md` first and settle them with the user; then read `skills/godot-brainstorming/SKILL.md` for the structured design process
